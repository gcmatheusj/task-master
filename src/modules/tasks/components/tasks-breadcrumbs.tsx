...
interface TasksBreamcrumbsProps {
  project: Project
  task: Task
}

export function TasksBreadcrumbs ({ project, task }: TasksBreamcrumbsProps) {
  ...
  return (
    <div className="flex items-center gap-x-2">
      ...
      <ChevronRight className="size- lg:size-5 text-muted-foreground" />
